...
class SiteSettingsForm extends Component
{
    ...
    protected $messages = [
        ...
        'facebook_url.max' => 'Facebook username/userid must not exceed 255 characters.',
        'twitter_url.max' => 'Twitter username/userid must not exceed 255 characters.',
        'instagram_url.max' => 'Instagram username/userid must not exceed 255 characters.',
        'linkedin_url.max' => 'LinkedIn username/userid must not exceed 255 characters.',
        'youtube_url.max' => 'YouTube username/userid must not exceed 255 characters.',
        'teams_url.max' => 'Teams username/userid must not exceed 255 characters.',
        'telegram_url.max' => 'Telegram username/userid must not exceed 255 characters.',
    ];
